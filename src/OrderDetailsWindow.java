...
public class OrderDetailsWindow  {
	...
	private JTable getJTable1() {
		if(jTable1 == null) {
			...
			jTable1.setPreferredSize(new Dimension(602, 100));
		}
		return jTable1;
	}
	...
	private JLabel getJLabel3() {
		if(jLabel3 == null) {
			...
			jLabel3.setPreferredSize(new Dimension(300, 10));
		}
		return jLabel3;
	}
	...
	private JScrollPane getJScrollPane1() {
		if(jScrollPane1 == null) {
			...
			jScrollPane1.setPreferredSize(new Dimension(605, 100));
	...
	private JPanel getJPanel2() {
		if(jPanel2 == null) {
			jPanel2 = new JPanel();
			jPanel2.setPreferredSize(new Dimension(115, 181));
